        ...
        <div className="specs">
          {[t.specs.win, t.specs.mac].map((s, i) => (
            <div className="spec-card" key={i}>
              ...
              <div className="dl">
                <a className="btn btn-primary" href="#download" style={{padding:'10px 16px',fontSize:'13px'}}><Ic.Download size={14}/> {t.specs.install}</a>
              </div>
            </div>
          ))}
        </div>
...
function Download({ t }) {
  const icons = [Ic.Window, Ic.Apple, Ic.Apple, Ic.Folder];
  return (
            ...
            {t.download.rows.map((r, i) => {
              ...
              return (
                <div className="dl-row" key={i}>
                  ...
                  <button className="btn btn-primary"><Ic.Download size={14}/> {t.download.btn}</button>
                </div>
              );
            })}
          </div>
        ...
        <div className="donate">
          ...
          <div>
            ...
            <div className="actions">
              <a className="btn btn-primary" href="#"><Ic.Heart size={14}/> {t.donate.btn1}</a>
              <a className="btn btn-secondary" href="#"><Ic.Github size={14}/> {t.donate.btn2}</a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="grid">
          ...
          <div>
            ...
            <ul>{t.footer.community_links.map((l,i)=><li key={i}><a href="#">{l}</a></li>)}</ul>
          </div>
          <div>
            <h4>{t.footer.about}</h4>
            <ul>{t.footer.about_links.map((l,i)=><li key={i}><a href="#">{l}</a></li>)}</ul>
          </div>
        </div>
        <div className="legal">
